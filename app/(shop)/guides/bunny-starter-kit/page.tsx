...
export const metadata: Metadata = {
  title: "Rabbit Starter Kit: Everything You Need for Day One | Piggy Way Crossing",
  description:
      ...
      <div className="container mx-auto max-w-3xl px-6 py-12 sm:py-20 relative z-10">
        ...
        <article className="prose prose-lg prose-headings:text-primary-navy prose-a:text-secondary-mint prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl max-w-none text-gray-700 leading-relaxed">
          <p className="lead text-xl text-gray-600 mb-8">
            ...
            specific needs. Forget the backyard hutch—modern bunnies live indoors as
            part of the family.
          </p>

          <div className="bg-gray-50 rounded-xl p-8 my-10 border border-gray-200">
            <h3 className="text-primary-navy font-bold text-xl mt-0 mb-6 flex items-center gap-2">
              <CheckCircle2 className="h-6 w-6 text-secondary-mint" />
              The Bunny Checklist
            </h3>
            <ul className="grid gap-3 list-none pl-0 m-0">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-base m-0">
                  <span className="text-secondary-mint font-bold mt-1">•</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <p>
            Most commercial rabbit cages are too small. An exercise pen (X-Pen) for
            dogs is actually the best starter home for a bunny. It provides ample
            room to hop, stretch, and flop.
          </p>
          <p>
            Line the floor with a waterproof fleece liner to protect your carpets
            and give your bunny traction.
          </p>
          ...
          <ul>
            <li><strong>The Box:</strong> Get a large cat litter box (no lid).</li>
            <li><strong>The Litter:</strong> Use paper-based pellets (like Yesterday's News). Never use clumping clay litter.</li>
            <li><strong>The Trick:</strong> Place a pile of hay inside the litter box. Rabbits like to poop where they eat!</li>
          </ul>

          <h2>3. Diet</h2>
          <p>Like guinea pigs, rabbits need 80% hay.</p>
          <ul>
            <li><strong>Hay:</strong> Unlimited Timothy hay.</li>
            <li><strong>Veg:</strong> Dark leafy greens (romaine, parsley, cilantro).</li>
            <li><strong>Pellets:</strong> A small amount (1/4 cup per 5 lbs body weight) of plain timothy pellets.</li>
          </ul>

          <h2>4. Bunny Proofing</h2>
          <p>
            Rabbits love to chew wires. Before bringing your bunny home, cover all
            accessible cords with plastic tubing or block access to them. It protects
            your electronics and, more importantly, keeps your bunny safe from
            electric shock.
          </p>
        </article>
        ...
        <div className="mt-16 pt-10 border-t border-gray-200">
          <h3 className="text-2xl font-bold text-primary-navy mb-6">Bunny Essentials</h3>
          <div className="bg-secondary-mint/20 rounded-2xl p-8 sm:p-10 text-primary-navy relative overflow-hidden">
            <div className="relative z-10 max-w-lg">
              <h4 className="text-2xl font-bold mb-3">X-Pen Floor Liners</h4>
              <p className="text-primary-navy/80 mb-6 text-lg">
                Our extra-large liners are designed specifically for standard 4x4
                exercise pens. Waterproof, washable, and bunny-approved.
              </p>
              <Link
                href="/shop-all"
                className="inline-flex items-center gap-2 bg-primary-navy text-white hover:bg-primary-navy-light rounded-full px-6 py-3 font-semibold transition-colors shadow-sm"
              >
