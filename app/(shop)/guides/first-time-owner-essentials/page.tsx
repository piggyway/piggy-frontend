...
export const metadata: Metadata = {
  title: "First-Time Guinea Pig Owner: Complete Essentials Checklist | Piggy Way Crossing",
  description:
...
export default function FirstTimeOwnerPage() {
  ...
  return (
    <div className="bg-white min-h-screen font-sans text-gray-900 selection:bg-primary-gold/20">
      ...
      <div className="container mx-auto max-w-3xl px-6 py-12 sm:py-20 relative z-10">
        ...
        {/* Article Content */}
        <article className="prose prose-lg prose-headings:text-primary-navy prose-a:text-primary-gold prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl max-w-none text-gray-700 leading-relaxed">
          <p className="lead text-xl text-gray-600 mb-8">
            Congratulations on your new furry family members! To make your shopping
            trip easier, we've compiled the definitive list of must-haves for day
            one.
          </p>
          ...
          <p>
            Your pigs need room to zoom! Skip the small pet store cages and opt for a
            C&C cage or a Midwest habitat. For bedding, fleece liners are the modern
            standard—they're reusable, save money over time, and are much cleaner than
            wood shavings.
          </p>

          <h2>2. Diet Basics</h2>
          <p>
            <strong>Hay is life.</strong> It should make up 80% of their diet. Stock up
            on a large bag of Timothy hay.
          </p>
          <p>
            For pellets, look for plain Timothy-based pellets (like Oxbow). Avoid the
            colorful mixes with seeds and dried fruit; they are unhealthy "junk food."
          </p>

          <h2>3. Hideouts & Comfort</h2>
          <p>
            Guinea pigs are prey animals and need to feel secure. A simple plastic
            igloo is fine, but soft fleece hideouts and tunnels provide extra comfort
            and warmth.
          </p>
        ...
        <div className="mt-16 pt-10 border-t border-gray-200">
          <h3 className="text-2xl font-bold text-primary-navy mb-6">Get Started with Our Bundles</h3>
          <div className="bg-primary-navy rounded-2xl p-8 sm:p-10 text-white relative overflow-hidden">
            <div className="relative z-10 max-w-lg">
              <h4 className="text-2xl font-bold mb-3 text-white">New Piggy Parent Starter Kit</h4>
              <p className="text-white/80 mb-6 text-lg">
                We've bundled our best-selling fleece liners, a cozy hideout, and a
                hay bag into one convenient, discounted package.
              </p>
              <Link
                href="/shop-all"
                className="inline-flex items-center gap-2 bg-white text-primary-navy hover:bg-gray-100 rounded-full px-6 py-3 font-semibold transition-colors"
              >
