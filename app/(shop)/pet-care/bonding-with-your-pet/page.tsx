...
export const metadata: Metadata = {
  title: "Bonding Tips: Building Trust with Guinea Pigs & Rabbits | Piggy Way Crossing",
  description:
...
export default function BondingPage() {
  ...
  return (
    <div className="bg-white min-h-screen font-sans text-gray-900 selection:bg-secondary-pink/20">
      ...
      <div className="container mx-auto max-w-3xl px-6 py-12 sm:py-20 relative z-10">
        ...
        {/* Article Content */}
        <article className="prose prose-lg prose-headings:text-primary-navy prose-a:text-secondary-pink prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl max-w-none text-gray-700 leading-relaxed">
          <p className="lead text-xl text-gray-600 mb-8">
            Earning the trust of a prey animal is one of the most rewarding
            experiences a pet owner can have. Unlike dogs, who often love instantly,
            guinea pigs and rabbits require patience, consistency, and a lot of
            snacks.
          </p>
          ...
          <div className="bg-pink-50 border-l-4 border-pink-400 p-6 my-6 rounded-r-lg">
            <p className="text-pink-900 font-bold mb-0">
          ...
          <p>
            When you first bring your pet home, give them space. For the first few
            days, just sit near their cage and talk softly or read a book aloud. Let
            them get used to your scent and the sound of your voice without the
            pressure of interaction.
          </p>

          <h2>Step 2: The Way to the Heart (Food!)</h2>
          <p>
            Food is your best bonding tool. Start hand-feeding their favorite veggies
            (parsley, cilantro, or a piece of pepper).
          </p>
          <ul>
            <li>Hold the food still and let them approach.</li>
            <li>Don't try to touch them yet—just let them associate your hand with good things.</li>
            <li>Be patient! This might take days or weeks.</li>
          </ul>

          <h2>Step 3: Floor Time</h2>
          <p>
            Once they take food from your hand comfortably, move to a secure floor
            area (like a playpen or a blocked-off room).
          </p>
          <ul>
            <li>
              <strong>Lie Down:</strong> Get on their level. Standing up makes you a
              scary giant. Lying down makes you less threatening.
            </li>
            <li>
              <strong>Be a Statue:</strong> Let them investigate you. They might sniff
              you, climb on you, or nibble your clothes. Stay still!
            </li>
            <li>
              <strong>Positive Reinforcement:</strong> Have treats ready for brave interactions.
            </li>
          </ul>
          ...
          <ul>
            <li><strong>Scoop, Don't Grab:</strong> Support their bum and chest securely.</li>
            <li><strong>Use a Snuggle Sack:</strong> Many pigs feel safer being picked up inside a cuddle sack or tunnel rather than by bare hands.</li>
            <li><strong>Short Sessions:</strong> Start with 5-10 minutes of lap time with food.</li>
          </ul>

          <h2>Signs of Affection</h2>
          <p>How do you know it's working? Look for these signs:</p>
          <ul>
            <li><strong>Wheeking:</strong> Excited squeaking when they see you (or the fridge!).</li>
            <li><strong>Popcorning:</strong> Jumping for joy in mid-air.</li>
            <li><strong>Pancaking:</strong> Relaxing flat on the ground with legs kicked out.</li>
            <li><strong>Purring:</strong> A low, vibrating rumble (usually happy, though pitch matters!).</li>
          </ul>

          <div className="bg-green-50 p-6 my-8 rounded-lg border border-green-100">
            <h4 className="text-green-800 font-bold mt-0 mb-2">Pro Tip: Routine</h4>
            <p className="text-green-700 mb-0 text-sm">
              Animals love predictability. Try to bond at the same time every day, like during morning veggie time or evening TV time. Consistency builds trust faster!
            </p>
          </div>
        </article>
        ...
        <div className="mt-16 pt-10 border-t border-gray-200">
          <h3 className="text-2xl font-bold text-primary-navy mb-6">Bonding Tools</h3>
