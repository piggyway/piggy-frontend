...
export function NavigationMenuContent({ items, className = '' }: NavigationMenuContentProps) {
  return (
    <div
      className={`bg-white flex flex-col gap-2 p-[14px] rounded-md shadow-md ${className}`}
...
function NavigationMenuContentItem({ title, description, href }: NavigationMenuContentItemProps) {
  const content = (
    <div className="bg-white flex flex-col gap-[10px] p-3 rounded-md">
