...
export const WHO_ITS_FOR_ITEMS = [
  {
    ...
    description: "A safe and cosy place for your guinea pigs while you're away.",
    colorClass: "bg-[#dcd7ff]/40",
  },
  {
    title: "Care for owners who worry a little extra",
    description: "Thoughtful, attentive care for piggies that mean the world to you.",
    colorClass: "bg-[#fffcef]",
  },
  {
    title: "Piggies with their own routines",
    description: "We follow their usual feeding habits and daily rhythm whenever possible.",
    colorClass: "bg-[#ffdfdf]",
  },
  {
    title: "Boarding with veterinary support",
    description: "Our partnership with an experienced pocket-pet vet provides extra peace of mind.",
    colorClass: "bg-[#fffbf5]",
  },
  {
    title: "Calm spaces for tiny feet",
    description: "A quiet, home-style environment designed to keep piggies relaxed.",
    colorClass: "bg-[#e1f2ef]",
  },
  {
    title: "First stay? No worries.",
    description: "A gentle introduction for guinea pigs boarding away from home.",
...
export const CARE_LEAD_CONTENT = {
  ...
  quote:
    "Because great care isn't loud — it's calm, attentive, and kind.",
  name: "Liv Ye",
