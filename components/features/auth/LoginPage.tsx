        ...
        <div className="relative hidden h-full flex-col bg-neutral-100 p-10 text-white lg:flex dark:border-r">
          ...
          <div className="relative z-20 flex flex-1 flex-col justify-center">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;The best place for all your guinea pig and rabbit needs. My piggies have never been happier!&rdquo;
              </p>
        ...
        <div className="lg:p-8">
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            ...
            <p className="px-8 text-center text-sm text-slate-500">
              ...
              <Link
                href="/terms"
                className="underline underline-offset-4 hover:text-primary-navy"
              >
                Terms of Service
              </Link>{" "}
              and{" "}
