...
>
> **Ignore `.Codex/rules/architecture.md`** — it was copied from a different project (Directus `server-actions`, `src/templates`, `bsx_article` collections) and does **not** describe this codebase. The accurate architecture is below.
>
> Note: `.Codex/AGENTS.md` imports `@./AGENTS.md`, but `.Codex/AGENTS.md` does not exist — that import currently resolves to nothing.
